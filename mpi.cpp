...
void performMatrixMultiplication(const int matrix1[][SIZE], const int matrix2[][SIZE], int resultMatrix[][SIZE], int rank, int size)
{
    int rows = SIZE / size;
    int start = rank * rows;
    int end = (rank + 1) * rows;
...
int main(int argc, char **argv)
{
    ...
    performMatrixMultiplication(matrix1, matrix2, resultMatrix, rank, size);
